...
from dash import dcc, html, callback_context, ALL, Input, Output, State, register_page
...
layout = get_base_layout(indicators=indicators_dict, main_title=main_title)
